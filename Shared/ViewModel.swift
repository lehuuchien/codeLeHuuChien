...
class IdeasViewModel: ObservableObject {
    @Published var listCommunityIdeas: [ModelCommunityIdeas] = []
    ...
    func getdataCommunity() {
        let data = [ModelCommunityIdeas(image: "view1", title: "Daily Morning Note", article: "Daily Morning Note - 11 August 2021", subArticle: "Aug 11, 2021"),
